...
scene dw 80 dup (border) ; 1723h - blue border, 4823h - red border, 0020h - empty space, 0EFAh - food   
      dw border, 0020h, 76 dup (0EFAh), 0020h, border
      dw border, 0020h, 7 dup (border), 0020h, 10 dup (border), bonus, 15 dup (border), 0020h, 6 dup (border), 0020h, 15 dup (border), bonus, 10 dup (border), 0020h, 7 dup (border), 0020h, border
      dw border, 0020h, 7 dup (border), 0020h, border, 8 dup (0020h), border,  0020h, border, 13 dup (0020h), border, 0020h, border, 4 dup (0020h), border, 0020h, border, 13 dup (0020h), border, 0020h, border, 8 dup (0020h), border, 0020h, 7 dup (border), 0020h, border
      dw border, 0020h ,7 dup (0EFAh), 0020h, border, 8 dup (0020h), border,  0020h, border, 13 dup (0020h), border, 0020h, border, 4 dup (0020h), border, 0020h, border, 13 dup (0020h), border, 0020h, border, 8 dup (0020h), border, 0020h ,7 dup (0EFAh), 0020h, border
      dw border, 0020h, 7 dup (border), 0020h, border, 8 dup (0020h), border,  0020h, 15 dup (border), 0020h, border, 4 dup (0020h), border, 0020h, 15 dup (border), 0020h, border, 8 dup (0020h), border, 0020h, 7 dup (border), 0020h, border
      dw border, 0020h, 7 dup (border), 0020h, border, 8 dup (0020h), border,  0020h, 15 dup (0EFAh), 0020h, border, 4 dup (0020h), border, 0020h, 15 dup (0EFAh), 0020h, border, 8 dup (0020h), border, 0020h, 7 dup (border), 0020h, border
      dw border, 0020h ,7 dup (0EFAh), 0020h, border, 8 dup (0020h), border,  0020h, 15 dup (border), 0020h, border, 4 dup (0020h), border, 0020h,15 dup (border), 0020h, border, 8 dup (0020h), border, 0020h ,7 dup (0EFAh), 0020h, border
      dw 9 dup (border), 0020h, border, 8 dup (0020h), border, 0EFAh, border, 13 dup (0020h), border, 0020h, border, 4 dup (0020h), border, 0020h, border, 13 dup (0020h), border, 0EFAh, border, 8 dup (0020h), border, 0020h, 9 dup (border)
      dw border, 7 dup (0020h), border, 0020h, border, 8 dup (0020h), border, 0EFAh, border, 12 dup (0020h), 2 dup (border), 0020h, 6 dup (border), 0020h, 2 dup (border), 12 dup (0020h), border, 0EFAh, border, 8 dup (0020h), border, 0020h, border, 7 dup (0020h), border
      dw border, 7 dup (0020h), border, 0020h, border, 8 dup (0020h), border, 0EFAh, border, 12 dup (0020h), border, 10 dup (0020h), border, 12 dup (0020h), border, 0EFAh, border, 8 dup (0020h), border, 0020h, border, 7 dup (0020h), border
      dw 9 dup (border), 0020h, 10 dup (border), 0EFAh, 14 dup (border), 0020h, 3 dup (border), 2 dup (0020h), 3 dup (border), 0020h, 14 dup (border), 0EFAh, 10 dup (border), 0020h, 9 dup (border)
      dw 20 dup (0020h), 0EFAh, 15 dup (0020h), border, 6 dup (0020h), border, 15 dup (0020h), 0EFAh, 20 dup (0020h)
      dw 9 dup (border), 0020h, 10 dup (border), 0EFAh, 14 dup (border), 0020h, 8 dup (border), 0020h, 14 dup (border), 0EFAh, 10 dup (border), 0020h, 9 dup (border)
      dw border, 7 dup (0020h), border, 0020h, border, 8 dup (0020h), border, 0EFAh, border, 12 dup (0020h), border, 0020h, 8 dup (0EFAh), 0020h, border, 12 dup (0020h), border, 0EFAh, border, 8 dup (0020h), border, 0020h, border, 7 dup (0020h), border
      dw border, 7 dup (0020h), border, 0020h, border, 8 dup (0020h), border, 0EFAh, border, 12 dup (0020h), border, 0020h, 8 dup (border), 0020h, border, 12 dup (0020h), border, 0EFAh, border, 8 dup (0020h), border, 0020h, border, 7 dup (0020h), border
      dw 9 dup (border), 0020h, border, 8 dup (0020h), border, 0EFAh, border, 12 dup (0020h), border, 0020h, border, "PAAACAMAAANA", border, 0020h, border, 12 dup (0020h), border, 0EFAh, border, 8 dup (0020h), border, 0020h, 9 dup (border)
      dw border, 0020h ,7 dup (0EFAh), 0020h, border, 8 dup (0020h), border, 0020h, 14 dup (border), 0020h, 8 dup (border), 0020h, 14 dup (border), 0020h, border, 8 dup (0020h), border, 0020h ,7 dup (0EFAh), 0020h, border
      dw border, 0020h, 7 dup (border), 0020h, border, 8 dup (0020h), border, 0020h, 38 dup (0EFAh), 0020h, border, 8 dup (0020h), border, 0020h, 7 dup (border), 0020h, border
      dw border, 0020h, 7 dup (border), 0020h, border, 8 dup (0020h), border, 0020h, 38 dup (border), 0020h, border, 8 dup (0020h), border, 0020h, 7 dup (border), 0020h, border
      dw border, 0020h ,7 dup (0EFAh), 0020h, border, 8 dup (0020h), border, 0020h, border, 0020h, "SACAOARAEA:A", 0020h, 4 dup (0F30h), 20 dup (0020h), 3 dup (heart), 0020h, border, 0020h, border, 8 dup (0020h), border, 0020h ,7 dup (0EFAh), 0020h, border
      dw border, 0020h, 7 dup (border), 0020h, border, 8 dup (0020h), border, 0020h, border, 36 dup (0020h), border, 0020h, border, 8 dup (0020h), border, 0020h, 7 dup (border), 0020h, border
      dw border, 0020h, 7 dup (border), 0020h, 10 dup (border), bonus, 38 dup (border), bonus, 10 dup (border), 0020h, 7 dup (border), 0020h, border
      dw border, 0020h, 76 dup (0EFAh), 0020h, border
      dw 80 dup (border)   
...
left_same_score:
    mov es:[di], 0020h ; PACMAN went away
