...
calculate_row_num_proc proc near
    ...
    read_from_file:
        ...
        cmp fread_buffer,9 ;\t
            je  tab 
        cmp byte ptr fread_buffer, 32
            jne row_is_not_empty_start
        tab:
        mov fread_last_string,1
        inc_row_end:
        ;putchar fread_buffer
        jmp read_from_file
    inc_row_start:
        add fread_row_count,1
        cmp fread_is_row_empty,0
        mov fread_last_string,0
            je inc_filled_row_start
        jmp inc_row_end
    row_is_not_empty_start:
        mov fread_is_row_empty,0
        jmp inc_row_end
    inc_filled_row_start:
        inc fread_filled_row_count
        mov fread_is_row_empty,1
        jmp inc_row_end
    eof:
    cmp fread_is_row_empty,0
        jne last_string_check
    inc fread_filled_row_count
        jmp inc_row_
    last_string_check:
        ; jne calculate_row_num_proc_end
    ; inc fread_empty_row_count
    ; cmp fread_last_string,1
    add_num  fread_row_count,fread_last_string
    jmp calculate_row_num_proc_end
    inc_row_:
    inc fread_row_count
    calculate_row_num_proc_end:
